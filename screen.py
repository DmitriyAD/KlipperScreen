...
class KlipperScreen(Gtk.Window):
    ...
    def _confirm_send_action_shutdown(self, widget, text):
        _ = self.lang.gettext
        ...
        self.gtk.Dialog(self, buttons, label, self._confirm_send_action_shutdown_response)
   
    def  _confirm_send_action_shutdown_response(self, widget, response_id):
        if response_id == Gtk.ResponseType.OK:
